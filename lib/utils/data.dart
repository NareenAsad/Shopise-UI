...
List<String> heelDescriptions = [
  ...
  "Spend the day in comfort with these wedge sandals, perfect for casual outings.",
...
List<String> accessoryDescriptions = [
